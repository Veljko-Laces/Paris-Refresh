<template>
    <div class="xl:mt-35 lg:mt-35 md:mt-35 mt-30 mb-10 px-4 md:px-8 lg:px-20 xl:px-8 flex flex-col gap-6 md:gap-8 lg:gap-10 xl:gap-12">
        <h1 class="text-2xl md:text-3xl lg:text-4xl xl:text-4xl">Bienvenue sur <span class="text-[#5f259f]">Paris Refresh</span></h1>
        ...
        <div class="flex flex-col gap-4">
            ...
            <p>Les données de ce site sont issues de <a href="https://opendata.paris.fr/pages/home/" target="_blank" class="text-[#5f259f]">Open Data Paris</a></p>
        </div>
    </div>
</template>
